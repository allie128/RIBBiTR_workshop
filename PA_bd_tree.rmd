...
**the file *PA_combined_trees.newick* is also in the folder "intermediate_files_jic" so you can just copy paste this into your working directory if you can't get this concatenate command to work**
...
**on PC copy and paste the *PA_trees_collapse10.newick* from the folder "intermediate_files_jic" to the working directory**
...
**on PC copy and paste the *PA_astral_collapse5.tre* from the folder "intermediate_files_jic" to the working directory**
